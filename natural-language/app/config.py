...
class Settings(BaseSettings):
    ...
    # Vector DB settings
    VECTOR_DB_TYPE: str = os.getenv("VECTOR_DB_TYPE", "chroma")  # chroma, pinecone, etc.
    ...
    # LLM settings
    LLM_PROVIDER: str = os.getenv("LLM_PROVIDER", "openrouter")  # openrouter, huggingface, ollama
